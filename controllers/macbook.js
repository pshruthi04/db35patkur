...
// List of all macbooks
exports.macbook_list = function(req, res) {
res.send('NOT IMPLEMENTED: macbook list');
};
...
exports.macbook_create_post = async function (req, res) {
    ...
    document.memory = req.body.memory;
    try {
...
if(req.body.memory)toUpdate.memory = req.body.memory;
...
exports.macbook_view_all_Pmemory = async function(req, res) {
    try{
        themacbook = await macbook.find();
...
exports.macbook_view_one_Pmemory = async function(req, res) {
...
exports.macbook_create_Pmemory = function(req, res) {
...
exports.macbook_update_Pmemory =  async function(req, res) { 
...
exports.macbook_delete_Pmemory = async function(req, res) {
