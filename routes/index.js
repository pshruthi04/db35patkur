...
router.get('/', function (req, res) { 
    res.render('index', { title: 'macbook App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'macbook App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'macbook App Login', user : req.user }); 
}); 
